    ...
    // console.log("Chai",thumbBlog)
        ...
        return (
            ...
            {/* <div className='hidden md:block lg:hidden absolute bg-white h-full w-[40%] z-[8] left-[-20%] blur-[100px] rounded-full'></div> */}
              ...
              <div className='hidden md:block lg:hidden absolute bg-white h-full w-[40%] z-[8] left-[-20%] blur-[100px] rounded-full'></div>
              {/* <button className='prev lg:top-[45%] lg:left-[0%] lg:p-3 w-fit h-fit md:p-3  bg-white rounded-full border border-solid shadow relative md:top-1/2 md:left-[2%] z-10  top-[50%] left-0 p-3   md:block' style={{ display: showPrevButton ? "block" : "none" }}>
                    ...
                    <button className='prev lg:-mt-12 lg:relative  lg:top-[50%] lg:left-[0%] lg:translate-y-[-50%] lg:p-3 w-fit h-fit md:p-3  bg-white rounded-full borderLine shadow md:absolute md:top-1/2 md:translate-y-[-50%] md:left-[2%] z-10  top-[39.5%] translate-y-[-50%]  absolute left-[-5%]  p-3   md:block' style={{ opacity: showPrevButton ? 1 : 0 }}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="text-[#2D89C8] w-[24px] h-[24px] font-bold">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" />
                    </svg>
                </button>
                ...
                >
                    ...
                    {blogs.map((ele,idx)=>{
                        ...
                        return ( <SwiperSlide key={idx} className='w-[300px]' >
                ...
                {/* yh swipper ka right button ko hide krna ka code hai style={{ display: showNextButton ? "block" : "none" }} */}
                {/* <button className='next lg:top-1/2 lg:right-[6%] lg:p-3 md:p-3  bg-white rounded-full border border-solid z-[777]  shadow absolute md:top-1/2 md:right-[2%] top-[50%] right-0 p-3  md:block' >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="text-[#2D89C8] w-[24px] h-[24px] font-bold ">
...
<button className='next lg:relative lg:-mt-12 lg:top-[50%] lg:right-[0%] lg:translate-y-[-50%] lg:p-3 md:p-3  bg-white rounded-full borderLine z-[777]  shadow-md md:absolute absolute md:top-1/2 md:right-[2%] top-[39.5%] translate-y-[-50%]  right-[-5%] p-3  md:block' >
            ...
            //     {/* <div className='flex gap-[40px] justify-evenly items-center'> */}
            //     <div className='hidden md:block lg:hidden absolute bg-white h-full w-[40%] z-[8] left-[-20%] blur-[100px] rounded-full'></div>
            //         <button className='prev lg:top-1/2 lg:left-[5%] lg:p-3 md:p-3 bg-white rounded-full border border-solid shadow absolute md:top-1/2 md:left-[2%] z-10  top-[50%] left-0 p-3   md:block' style={{ display: showPrevButton ? "block" : "none" }}>
            //             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="text-[#2D89C8] w-[24px] h-[24px] font-bold">
            //                 <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" />
            //             </svg>
            //         </button>
            ...
            //         {/* yh swipper ka right button ko hide krna ka code hai style={{ display: showNextButton ? "block" : "none" }} */}
            //         <button className='next lg:top-1/2 lg:right-[6%] lg:p-3 md:p-3  bg-white rounded-full border border-solid z-10 shadow absolute md:top-1/2 md:right-[2%] top-[50%] right-0 p-3  md:block' >
            //             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="text-[#2D89C8] w-[24px] h-[24px] font-bold ">
            //                 <path strokeLinecap="round" strokeLinejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
            //             </svg>
            //         </button>
    ...
    // const [blogs,readMoreData, setBlogs] = useGetBlogs([
    // //     {
    ...
    //                 {/* <div className='flex gap-6'> */}
    //                 {blogs.map((ele,idx) => {
    //                     return <SwiperSlide key={idx} className='w-[300px]' ><BlogCard blog={ele} idx={idx} /></SwiperSlide>
    //                     // <BlogCard blog={ele} />
    //                 })}
    //                 {/* <SwiperSlide></SwiperSlide> */}
    //             </Swiper>
