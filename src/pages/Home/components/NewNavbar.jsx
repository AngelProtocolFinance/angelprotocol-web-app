...
const NewNavbar = () => {
  ...
  return (
 <>
 <nav className={'bg-[#fff] ease-in-out duration-400 top-0 left-0 w-full fixed  z-[9999] lg:h-[68px] h-[68px] shadow-md flex justify-between items-center  md:px-[40px] lg:px-[40px] xl:px-[40px] xl:h-[68px] px-5 md:w-full lg:w-full Quicksand m-auto overflow-hidden' } >
 <DappLogo classes="w-48 h-12" />
 <label htmlFor="search" className='search lg:w-[33%] absolute lg:left-[650px] md:left-[280px] md:w-[35%] w-[8%] h-full flex items-center  gap-3'>
    ...
    <input type="search" name="search" id="search" placeholder='Explore Non Profits' value={search} onChange={(e)=>setSearch(e.target.value)} className='w-[85%] p-1 outline-none relative hidden md:block' />
  </label>
