...
const HeroBottom = () => {
  ...
  return (
    <div className="relative bottom-[300px] lg:bottom-[300px]   md:bottom-[350px] z-10 pt-[50px] px-[24px] ">
      ...
      <div className="flex flex-col items-center gap-5   ">
        <span className="flex flex-col items-center gap-3 mb-10 ">
          <h3 className="text-lg uppercase font-bold text-[#2D89C8] Quicksand text-[13px] md:text-[18px]">
            Bridge to better
          </h3>
          <h2 className="text-[32px] md:text-[42px] lg:w-full md:w-8/12 text-center capitalize font-bold text-[#183244] Quicksand">
      ...
      >
        ...
        <p className="bg-[#FFEECC] Gochi_Hand text-2xl z-[22] px-4">
      ...
      {/* <img src="/frame_1.png" alt="frame1" className='  absolute top-[12%] md:top-[12%] left-[2%] md:left-[6%] lg:top-[16%]  lg:left-[8%]  -left-5 md:scale-[1] scale-[.7] md:scale-[.85] lg:scale-[.9] -z-10'/>
      <img src="/frame_2.png" alt="frame2" className='  md:scale-[.8] md:scale-[.7] scale-[.6]   absolute lg:top-[12%] top-[6%] right-0 lg:left-[80%] md:top-[10%] md:hidden lg:block md:left-[75%] -z-10'/>
      <img src="/frame_3.png" alt="frame3" className='absolute lg:top-[22%] lg:right-[0%] md:top-[22%] md:right-[0%] -top-3 right-2  md:scale-[.9] lg:scale-[.9] scale-[.7] z-10 hidden md:block'/>
      <img src="/frame_4.png" alt="frame4" className='    scale-[.8] opacity-60 absolute lg:top-[32%] lg:left-[86%] md:top-[32%] md:left-[84%]    -z-[9] hidden lg:block '/>
      <img src="/frame_5.png" alt="frame5" className='  absolute md:top-[32%] md:right-[22%] md:scale-[.8] lg:scale-[.8]  lg:top-[30%] lg:left-[33%]  opacity-40 -z-[9]  hidden md:block'/>
      <img src="/frame_6.png" alt="frame6" className='   absolute md:top-[38%] md:left-[.5%] lg:top-[38%]  top-[32.5%] -left-2 -z-10 scale-[.8]  lg:left-[3%]'/>
     */}
    </div>

    // <div className='relative bottom-[350px] lg:bottom-[300px] md:bottom-[350px] z-10 pt-[150px] px-[24px] '>
    //   <img src="/map.png" alt="map" className='absolute lg:bottom-[-17%] lg:left-8 md:bottom-[-6%] md:left-4  z-[1] bottom-[-2%] left-0 opacity-80 lg:scale-[1] md:scale-[1.5] scale-[2.8] object-cover object-center'/>
    ...
    //       <path d="M195 1091.5C43.4 1208.3 -115.5 813.443 -157 685.443C-157 495.043 -547 418.11 -742 403.443C-485.667 390.943 162.4 362.643 704 349.443C1381 332.943 1489.5 782.943 947.5 685.443C405.5 587.943 384.5 945.5 195 1091.5Z" fill="#3DD3A6" fillOpacity="0.5" />
    //     </g>
    //     <defs>
    //       <filter id="filter0_f_443_2773" x="-1162" y="-71" width="2874.37" height="1603.84" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
    //         <feFlood floodOpacity="0" result="BackgroundImageFix" />
    ...
    //       <h2 className='text-[32px] md:text-[42px] lg:w-full md:w-8/12 text-center capitalize font-bold text-[#183244] Quicksand'>Connecting Donors to Causes That Matter</h2>
    //     </span>

    //     <div className='flex gap-2  '>
    //     <div className='hidden md:block lg:hidden absolute bg-white h-[70%] w-[40%] z-[8] left-[-20%] blur-[100px] rounded-full'></div>
    //     <button className=' p-3 bg-white rounded-full border border-solid shadow self-center cause-prev  absolute top-[57%] left-0 md:top-[56%] md:left-[2%] lg:top-[50%] lg:left-[5%] z-10  md:block' style={{ display: showPrevButton ? "block" : "none" }}>
    ...
    //       {
    //         donations.map((ele, idx) => {
    //           return <SwiperSlide key={idx}><Card name={ele.name} work={ele.work} supporters_count={ele.supporters_count} img_src={ele.img_src} logo={ele.logo_img} /></SwiperSlide>
    //         })
    //       }
    //       {/* <SwiperSlide className=''></SwiperSlide>
    //       <SwiperSlide className=''></SwiperSlide>
    ...
    //     <button className='p-3  bg-white rounded-full border border-solid z-10 shadow self-center cause-next absolute top-[57%] right-0 md:top-[56%] md:right-[2%] lg:top-[50%] lg:right-[6.2%]  md:block' >
    //         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="text-[#2D89C8] w-[24px] h-[24px] font-bold ">
    //             <path strokeLinecap="round" strokeLinejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
    //         </svg>
    //         </button>

    //             <div className='hidden md:block lg:hidden absolute bg-white h-[70%] w-[40%] z-[8] right-[-20%]  blur-[100px] rounded-full'></div>
    //     </div>

    //     <div className="-mt-30 z-40"><Button text={"Explore All Causes"} /></div>
    //     <p className='bg-[#FFEECC] Gochi_Hand text-2xl z-[22] px-4'>from all around the globe</p>
    //     {/* <img src="/map.svg" alt="map" className='absolute bottom-0 left-0 w-full h-full' /> */}
    //   </div>
    //   <img src="/frame_1.png" alt="frame1" className='  absolute top-[2%] md:top-[5%] left-[-8%] md:left-[3%] lg:top-[5%]  lg:left-[15%]  -left-5 md:scale-[.8] scale-[.6]  lg:scale-[.7]  -z-10'/>
    //   <img src="/frame_2.png" alt="frame2" className='  md:scale-[.7] md:scale-[.6] scale-[.5]   absolute  top-[-4%] right-[-5%] lg:top-[2%] lg:left-[74%] md:top-[8%] md:right-[4%]  md:block lg:block  -z-10 '/>
    //   <img src="/frame_3.png" alt="frame3" className='absolute lg:top-[15%] lg:right-[0%] md:top-[15%] md:right-[10%] -top-3 right-2  md:scale-[.9] lg:scale-[.9] scale-[.7] opacity-[.5]  z-10 hidden lg:block '/>
    //   <img src="/frame_4.png" alt="frame4" className='    scale-[.6] opacity-60 absolute lg:top-[25%] lg:left-[84%] md:top-[32%] md:left-[84%]     -z-[9] hidden lg:block '/>
    //   <img src="/frame_5.png" alt="frame5" className='  absolute md:top-[25%] md:right-[22%] md:scale-[.6] lg:scale-[.7]  lg:top-[20%] lg:left-[33%]  opacity-40 -z-[9]   hidden md:block'/>
    //   <img src="/frame_6.png" alt="frame6" className='   absolute md:top-[38%] md:left-[.5%] lg:top-[38%]  top-[25.5%] -left-2 -z-10 scale-[.7]   lg:left-[3%]'/>
