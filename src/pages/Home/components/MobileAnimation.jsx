...
<stop offset="1" stop-color="#FEFBFC"/>
   ...
   <h4 className=' text-[14px] z-[33] font-bold z w-full mx-auto text-[#3c91cb] text-center mb-[65px]   Quicksand'>SIMPLE PATH TO FINANCIAL STABILITY</h4>
  <div className="bg-[#fbf8f9]   w-full h-[120px] absolute top-10 blur-[15px] -z-1"> </div>
    <h2 className=' text-[32px] font-bold z-[88] -mt-10  w-[95%] mb-14  text-[#183244] text-center mx-auto    z-20  Quicksand'>Make a Lasting Impact: Give Today, Give Forever</h2>
...
//     <div className='md:hidden mobile_animationz -mb-[80%] relative overflow-visible'>
//         <svg id='svg3' xmlns="http://www.w3.org/2000/svg" width="360" height="1970" viewBox="0 0 360 1970" fill="none">
//         <path className="line2" d="M153.309 23C47.6725 28.2255 -103.673 36.7785 -2.79612 226.945C98.0809 417.111 367.742 284.47 379.727 535.49C391.712 786.51 -62.7237 797.919 3.19453 1152.1C69.1127 1506.29 492.587 1264.78 522.051 1629.42C551.514 1994.07 238.403 1623.72 161.498 1947" stroke="url(#paint0_linear_1054_18924)" strokeWidth="46" strokeLinecap="round"/>
...
// </svg>
//        {/* <div class="dot dot1 hidden"></div> */}
//        <div className='absolute top-0 h-full flex flex-col gap-[0px] justify-between px-[38px]'>
//        <h4 className=' text-[14px] font-bold w-full mb-2 text-[#3c91cb] text-center   Quicksand'>FUELING DREAMS, NURTURING HOPE</h4>
//       <div className="bg-[#fbf8f9]  w-full h-[120px] absolute top-10 blur-[15px] -z-1"> </div>
//         <h2 className=' text-[28px] font-bold   -mt-10  w-full   text-[#183244] text-center   z-20  Quicksand'>Better Giving's Path to Philanthropic Excellence</h2>
