...
const Footer = () => {
  return (
    <footer className="flex flex-col   lg:gap-[80px] gap-[50px] pt-[50px]  DM_Sans">
      <div className="flex flex-col lg:items-center  lg:justify-between  lg:flex-row md:flex-col px-[24px] lg:px-[65px] md:px-[30px] gap-[70px]  ">
        <div className="flex flex-col gap-[20px] lg:flex-col md:flex-row lg:max-w-[28%] lg:gap-6 md:gap-[30px] md:items-start md:justify-between">
          {/* <p className='text-[#2D85C8] text-2xl font-extrabold flex items-center gap-4 self-center md:self-auto Quicksand'>
                    <img src="/log0-an-png.png"  className=' scale-[1.5]' alt="logo" />
                   <p><span className=' font-extrabold text-[#3a729c] -ml-3 '> better.</span>giving</p>
                </p> */}
    ...
    //     <div className='flex flex-col lg:flex-row md:flex-col px-[24px] lg:px-[93px] md:px-[24px] gap-[45px] items-start  '>
    //         <div className='flex flex-col gap-[20px] lg:flex-col md:flex-row lg:max-w-[30%] lg:gap-6 md:gap-[30px] md:items-start md:justify-between'>
    //             {/* <p className='text-[#2D85C8] text-2xl font-extrabold flex items-center gap-4 self-center md:self-auto Quicksand'>
    //                 <img src="/log0-an-png.png"  className=' scale-[1.5]' alt="logo" />
    //                <p><span className=' font-extrabold text-[#3a729c] -ml-3 '> better.</span>giving</p>
    //             </p> */}

    //             <div className=" lg:w-[250px] md:w-[280px] w-[300px]    lg:h-16 md:h-16 h-20 md:scale-[1] lg:scale-[1] scale-[.9]  lg:-ml-9 md:-ml-2  -mb-2">
    //             <img src="/logo.svg"  className=' w-full h-full object-cover object-center  ' alt="logo" />
    //             </div>

    //             <p className='text-[14px] text[##00000099] text-start break-words md:p-0  lg:w-[85%]  md:w-[70%] lg:-ml-4 md:ml-6 font-medium opacity-70 leading-5'>Better.Giving simplifies sustainable funding for global grassroots organizations through fiscal sponsorship and free fundraising tools. Donors support directly or contribute to personal/nonprofit Sustainability Funds, ensuring perpetual impact through strategic investments.</p>
    //         </div>

    //         <div className='flex gap-[33px] flex-wrap md:flex-nowrap lg:self-auto md:self-center '>
    //             <div className='flex flex-col gap-5'>
    //                 <h6 className='text-base font-semibold text-[#4585bb] md:mb-0 -mb-2'>Our Support</h6>
    //                 <ul>
    //                     <li className='text-[14px] text[##00000099] whitespace-nowrap font-medium opacity-70'>Non-profits</li>
    //                     <li className='text-[14px] text[##00000099] mt-4  whitespace-nowrap font-medium opacity-70'>Giving Partners (CSR)</li>
    //                     <li className='text-[14px] text[##00000099] mt-4 whitespace-nowrap font-medium opacity-70'>Impact Board</li>
    //                 </ul>
    //             </div>
    //             <div className='flex flex-col gap-5'>
    //                 <h6 className='text-base font-semibold text-[#4585bb] md:mb-0 -mb-2'>Resources</h6>
    //                 <ul>
    //                     <li className='text-[14px] text[##00000099]  whitespace-nowrap font-medium opacity-70'>About</li>
    //                     <li className='text-[14px] text[##00000099] mt-4  whitespace-nowrap font-medium opacity-70'>FAQs</li>
    //                     <li className='text-[14px] text[##00000099] mt-4 whitespace-nowrap font-medium opacity-70'>News</li>
    //                 </ul>
    //             </div>
    //             <div className=' md:ml-7 lg:ml-8 ml-0 flex flex-col gap-5'>
    //                 <h6 className='text-base font-semibold text-[#4585bb] md:mb-0 -mb-2'>Legal</h6>
    //                 <ul>
    //                     <li className='text-[14px] text[##00000099]  whitespace-nowrap font-medium opacity-70'>Privacy Policy</li>
    //                     <li className='text-[14px] text[##00000099] mt-4  whitespace-nowrap font-medium opacity-70'>Terms of Use <br /> (Donors)</li>
    //                     <li className='text-[14px] text[##00000099] mt-4 whitespace-nowrap font-medium opacity-70'>Terms of Use <br /> (Non-Profits)</li>
    //                 </ul>
    //             </div>
    //         </div>

    //         <div className='flex flex-col gap-[24px] lg:ml-20 md:ml-0 lg:flex-col lg:gap-6 md md:flex-row md:gap-[48px]'>
    //             <span>
    //             <h6 className='text-base font-bold  text-[#4585bb] mb-1'>Subscribe to our newsletter</h6>
    //             <p className='text-[13px] text[#647581] text-justify font-medium opacity-70 md:w-[90%] w-[90%]'>
    ...
    //             </p>
    //             </span>
    //             <span className='flex flex-col md:items-start md:gap-[12px] gap-[12px] w-full  lg:w-full md:w-[65%]'>
    //                 <input type="text" name='email' id="email" placeholder='Enter your email' className=' cursor-default p-3 rounded-md font-medium border text-[15px] md:text-[13px] border-solid  border-[#0000001a] w-full' />
    //                 <button className='bg-[#2D89C8] rounded-[40px] px-8 py-2 text-white text-sm font-medium'>Subscribe</button>
    //             </span>
    ...
    //     <div className='lg:h-[64px] text-[#4585bb] font-medium    px-[24px] lg:px-[93px] py-[14px] flex justify-between items-center flex-col-reverse gap-[15px] lg:flex-row md:gap-[20px] bg-[#F1FAFF]'>
    //         <p className=' text-[12px]   md:text-[15px] text-center '>
    //            <span className=''> © Copyright 2023 Better.Giving, A Registered Charitable 501 (C) (3) (EIN 87-3758939)</span>
    //         </p>
    //         <span className='flex gap-3 items-center'>
