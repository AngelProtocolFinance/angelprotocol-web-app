      ...
      <div className="order-2 md:order-1">
        ...
        <div className="flex flex-col md:flex-row justify-center md:justify-start items-center gap-6">
          <Link
            ...
            className="btn-blue rounded-full px-8 py-3 md:px-12 md:py-6"
          >
            Start today
          </Link>
          <Link
            to={BOOK_A_DEMO}
            className="bg-white text-blue-d1 font-heading uppercase font-bold rounded-full px-8 py-3 md:px-12 md:py-6"
          >
            Book a Demo
          </Link>
        </div>
