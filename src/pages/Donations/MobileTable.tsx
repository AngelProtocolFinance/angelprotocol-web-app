...
export default function MobileTable({
  ...
  return (
    <div
      className={`${classes} border border-gray-l3 dark:border-bluegray ${
        hasMore ? "rounded-t" : "rounded"
      }`}
    >
      <div className="grid items-center grid-cols-[auto_1fr_auto] h-12 uppercase text-xs font-bold bg-orange-l6 dark:bg-blue-d7 border-b border-gray-l3 dark:border-bluegray divide-x divide-prim rounded-t">
        <div className="w-12" />
