    ...
    >
      <div className="max-w-2xl order-2 @6xl:order-1">
        ...
        <div className="flex flex-col @xl:flex-row justify-center @6xl:justify-start items-center gap-6">
          ...
          <Link
            to={BOOK_A_DEMO}
            className="capitalize text-center bg-white border-blue-d1 text-blue-d1 active:translate-x-1 font-semibold  border-2 rounded-xl px-6 py-2 @6xl:px-8 @6xl:py-4 @6xl:text-xl hover:shadow-2xl hover:shadow-blue/50"
          >
