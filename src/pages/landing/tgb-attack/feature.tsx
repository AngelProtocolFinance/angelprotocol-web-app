    ...
    >
      <div className="self-center max-lg:contents">
        ...
        <p className="text-gray max-lg:px-10 max-lg:text-center mb-4 text-xl">
          {APP_NAME} is a nonprofit donation platform built by nonprofits, for
      ...
      <Image
        ...
        height={350}
        src={photo}
        alt={`${APP_NAME} logo with leaves background`}
  ...
  return (
    <li className="grid gap-y-2 md:grid-rows-subgrid row-span-4 px-9 justify-items-center">
      <Image
        ...
        className="pb-2"
      />
      <h5 className="pb-2 text-center font-medium font-body @6xl:text-lg text-blue-d1 border-b-2 border-blue-d1 mb-4 px-8">
        {props.title1}
      </h5>
