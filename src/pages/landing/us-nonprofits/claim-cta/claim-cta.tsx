  ...
  return (
    <div className={`flex items-center gap-x-2 gap-y-4 py-4 ${classes}`}>
      ...
      <Link
        ...
        className="h-full flex items-center text-sm uppercase font-semibold  bg-blue-d1 text-white shadow-xl enabled:active:translate-x-1 hover:bg-blue-d2 rounded-full px-6 py-2 aria-disabled:bg-gray"
      >
        Get started
      </Link>
    </div>
