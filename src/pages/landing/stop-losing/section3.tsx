    ...
    <div className={`${classes} py-26`}>
      ...
      <div className="grid @6xl:grid-cols-2 gap-4">
        <div className="grid grid-rows-subgrid row-span-3 p-6 rounded-xl bg-blue-l5 border-blue-l4 border">
          <DollarSignIcon className="text-blue justify-self-center" />
        ...
        <div className="grid grid-rows-subgrid row-span-3 p-6 rounded-xl bg-blue-l5 border-blue-l4 border">
          <HeartIcon className="text-blue justify-self-center" />
          <h4 className="capitalize ">Built by Nonprofits, for Nonprofits</h4>
          <p className="">
