...
function Row(props: Props) {
  return (
    <>
      ...
      <div
        aria-hidden={true}
        className="max-sm:hidden w-px border-r border-gray-l3 dark:border-blue-gray last:border-none"
      />
      ...
      <div
        aria-hidden={true}
        className="h-px col-span-full border-b border-gray-l3 dark:border-blue-gray last:border-none"
      />
    </>
  );
}
