  ...
  return (
    ...
    >
      <div className="relative w-full">
        <p className="sm:text-xl font-bold text-center border-b bg-orange-l6 dark:bg-blue-d7 border-gray-l3 dark:border-blue-gray p-5 font-work">
        ...
        {isDismissible && (
          <button
            onClick={closeModal}
            disabled={isLoading}
            className="border border-gray-l3 dark:border-blue-gray p-2 rounded-md absolute top-1/2 right-4 transform -translate-y-1/2 disabled:text-gray-l3 dark:disabled:text-bluegray-d1 disabled:dark:border-bluegray-d1"
          >
      ...
      <div className="p-3 sm:px-8 sm:py-4 flex items-center justify-end gap-4 w-full text-center sm:text-right bg-orange-l6 dark:bg-blue-d7 border-t border-gray-l3 dark:border-blue-gray">
        <button
          disabled={isLoading}
          type="button"
