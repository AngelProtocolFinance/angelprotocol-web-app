  ...
  return (
    ...
    >
      ...
      <RichTextEditor<FV>
        ...
        classes={{
          container:
            "rich-text-toolbar border border-prim text-sm grid grid-rows-[auto_10rem] rounded bg-white dark:bg-blue-d3 aria-disabled:bg-gray-l4 aria-disabled:dark:bg-bluegray-d1 p-3 break-words",
