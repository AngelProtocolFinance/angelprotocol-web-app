  ...
  return (
    ...
    >
      ...
      <RichTextEditor<FV>
        ...
        classes={{
          container:
            "rich-text-toolbar border border-gray-l3 dark:border-bluegray text-sm grid grid-rows-[auto_10rem] rounded bg-white dark:bg-blue-d6 aria-disabled:bg-gray-l5 aria-disabled:dark:bg-bluegray-d1 p-3 break-words",
