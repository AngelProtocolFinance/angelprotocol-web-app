    ...
    >
      ...
      <div className="relative grid w-full border border-prim rounded-lg overflow-clip">
        ...
        <textarea
          ...
          {...register("secret")}
          className="text-lg bg-red-l6 dark:bg-blue-d3 disabled:bg-gray-l4 disabled:dark:bg-bluegray-d1 focus:outline-none text-center p-6 pb-4 break-all overflow-hidden font-work"
        />
        <ErrorMessage
          name="secret"
          as="p"
