...
export default function Form({ classes = "" }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative grid w-full border border-gray-l3 dark:border-bluegray rounded-lg overflow-clip">
        <p className="text-xs text-center uppercase text-gray-d1 dark:text-gray p-4 border-b border-gray-l3 dark:border-bluegray">
