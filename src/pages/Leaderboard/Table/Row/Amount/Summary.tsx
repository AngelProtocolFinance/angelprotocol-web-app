...
export default function Summary({ locked, liquid, type }: AmountProps) {
  ...
  return (
    <Modal className="grid content-start bg-gray-l4 dark:bg-blue-d4 text-gray-d2 border border-prim dark:text-white font-work fixed-center z-20 p-8 rounded-2xl shadow-lg max-w-md">
