...
export default function Table({ classes = "", endowments }: Props) {
  return (
    <div
      className={`${classes} h-[50rem] overflow-y-scroll scroller border border-gray-l3 dark:border-bluegray rounded`}
    >
      <table className="border-collapse table-auto w-full">
        <TableSection
          type="thead"
          rowClass="border-b border-gray-l3 dark:border-bluegray bg-orange-l6 dark:bg-blue-d6"
        >
          <Cells
            type="th"
