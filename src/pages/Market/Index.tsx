...
function Button({
  ...
  return (
    <button
      ...
      className={`${
        className || ""
      } w-22 h-22 p-2 flex rounded-full absolute top-1/2 -translate-y-1/2  group-hover:flex bg-blue-accent/60 hover:bg-blue/60 items-center justify-center group`}
    >
