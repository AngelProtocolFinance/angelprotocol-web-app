    ...
    >
      <div className="grid">
        ...
        <Link
          ...
          className="btn btn-blue justify-self-center normal-case px-10 py-3 xl:text-lg shadow-blue/30 hover:shadow-blue/50 active:translate-x-1 font-bold shadow-2xl rounded-full"
        >
          Sign Up Now
        </Link>
      </div>
