...
export default function PrivacyPolicy() {
  return (
    <article className="pt-24 pb-10 container px-5 mx-auto max-w-5xl">
      <h1 className="text-center text-3xl font-bold uppercase mt-10 mb-5">
        Privacy Policy
      </h1>
      <p className="text-black p-1">Last modified: August 1, 2021</p>
      <section className="mt-5">
        <h2 className="text-lg md:text-xl mb-2 font-bold uppercase">
          Introduction
        </h2>
        ...
        <p className="text-black md:ml-5 p-1">
          ...
          <Anchor to="https://angelprotocol.io">www.angelprotocol.io</Anchor>,
          as well as applications, products and services (collectively our "
          <Bold>Site</Bold>") on or in which it is posted, linked or referenced.
        ...
        <ul className="list-disc ml-5 md:ml-12 mt-1">
          <li className="p-1">On this Site.</li>
          <li className="p-1">
      ...
      <section className="mt-5">
        <h2 className="text-lg md:text-xl mb-2 font-bold uppercase font-sembold">
        ...
        <p className="text-black md:ml-5 p-1">
          ...
          <Mail email="hi@angelprotocol.io">hi@angelprotocol.io.</Mail>
        </p>
      </section>
      <section className="mt-5">
        <h2 className="text-lg md:text-xl mb-2 font-bold uppercase font-sembold">
        ...
        <p className="text-black md:ml-5 p-1">We collect this information:</p>
        <ul className="list-disc ml-5 md:ml-12 mt-1">
          <li className="p-1">Directly from you when you provide it to us.</li>
          <li className="p-1">
            That is about you but individually does not identify you; and/or
          </li>
          <li className="p-1">
      ...
      <section className="mt-5">
        ...
        <ul className="list-disc ml-5 md:ml-12 mt-1">
          ...
          <li className="p-1">Your search queries on the Site.</li>
        </ul>
        <p className="text-black md:ml-5 p-1">
          You also may provide information to be published or displayed
          (hereinafter, "<Bold>posted</Bold>") on public areas of the Site, or
          transmitted to other users of the Site or third parties (collectively,
          "<Bold>User Contributions</Bold>"). Your User Contributions are posted
          on and transmitted to others at your own risk. Although we limit
      ...
      <section className="mt-5">
        ...
        <ul className="list-disc ml-5 md:ml-12 mt-1">
          ...
          <li className="p-1">Speed up your searches.</li>
          <li className="p-1">Recognize you when you return to our Site.</li>
          <li className="p-1">
            The technologies we use for this automatic data collection may
            include:
          </li>
          <li className="p-1">
            <Bold>Cookies (or browser cookies).</Bold> A cookie is a small file
          ...
          <li className="p-1">
            <Bold>Flash Cookies.</Bold> atures of our Site may use local stored
          ...
          <li className="p-1">
            <Bold>Web Beacons.</Bold> Pages of our Site and our emails may
      ...
      <section className="mt-5">
        ...
        <ul className="list-disc ml-5 md:ml-12 mt-1">
          <li className="p-1">To present our Site and its contents to you.</li>
          <li className="p-1">
          ...
          <li className="p-1">For any other purpose with your consent.</li>
        </ul>
        <p className="text-black md:ml-5 p-1">
      ...
      <section className="mt-5">
        ...
        <ul className="list-disc ml-5 md:ml-12 mt-1">
          ...
          <li className="p-1">With your consent.</li>
        </ul>
        <p className="text-black md:ml-5 p-1">
      ...
      <section className="mt-5">
        ...
        <ul className="list-disc ml-5 md:ml-12 mt-1">
          <li className="p-1">
            <Bold>Tracking Technologies and Advertising.</Bold> You can set your
          ...
          <li className="p-1">
            <Bold>Promotional Offers from the Company.</Bold> If you do not wish
            ...
            <Mail email="hi@angelprotocol.io">hi@angelprotocol.io</Mail>. If we
        ...
        <p className="text-black md:ml-5 p-1">
          ...
          members of the Network Advertising Initiative ("<Bold>NAI</Bold>") on
          the NAI's{" "}
          <Anchor to="https://www.networkadvertising.org">Site</Anchor>.
        </p>
      </section>
      <section className="mt-5">
        <h2 className="text-lg md:text-xl mb-2 font-bold uppercase font-sembold">
        ...
        <p className="text-black md:ml-5 p-1">
          ...
          <Mail email="hello@angelprotocol.io">hello@angelprotocol.io</Mail>.
          The legal bases under which We may process your personal information
          include:
        </p>
        <ul className="list-disc ml-5 md:ml-12 mt-1">
          <li className="p-1">To provide our services to you.</li>
          <li className="p-1">
          ...
          <li className="p-1">To optimize our platform.</li>
          <li className="p-1">
            To notify you of new services, products and events that may be of
            interest.
          </li>
          <li className="p-1">To protect the vital interests of the public.</li>
          <li className="p-1">To personalize our services.</li>
          <li className="p-1">
      ...
      <section className="mt-5">
        ...
        <p className="text-black md:ml-5 p-1">
          ...
          <Mail email="hi@angelprotocol.io">hi@angelprotocol.io</Mail> to
        ...
        <ul className="list-disc ml-5 md:ml-12 mt-1">
          ...
          <li className="p-1">To correct and update your personal data.</li>
          <li className="p-1">
...
const Bold = ({ children }: { children: ReactText }) => (
...
const Mail = ({ children, email }: { children: ReactText; email: string }) => (
