export const PreCta = ({ classes = "" }) => (
  <p className={classes}>
    ...
    processing, <span className="font-semibold">save time</span> by handling all
    admin & reporting work, and{" "}
    <span className="font-semibold">save for your future</span> with simple but
