      ...
      <div className="order-2 md:order-1">
        ...
        <div className="flex flex-col md:flex-row justify-center md:justify-start items-center gap-6">
          <Link
            ...
            className="btn-blue active:translate-x-1 font-semibold shadow-2xl rounded-full px-6 py-2 md:px-10 md:py-5"
          >
            Join us today!
          </Link>
          <Link
            to={BOOK_A_DEMO}
            className="bg-white shadow-2xl hover:shadow-white/40 active:translate-x-1 text-blue-d1  font-semibold rounded-full px-6 py-2 md:px-10 md:py-5"
          >
            Book a demo
          </Link>
        </div>
