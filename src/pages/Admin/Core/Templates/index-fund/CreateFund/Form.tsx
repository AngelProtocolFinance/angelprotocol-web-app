...
function Slider() {
  ...
  return (
    <div className="text-gray-d2 grid mt-6">
      ...
      <div className="p-3 rounded-md bg-gray-l4 shadow-inner-white">
        <input
...
function CheckInput() {
  ...
  return (
    ...
    shadow-inner-white bg-gray-l4 my-6"
    >
      <input
  ...
  return (
    <div className="text-gray-d2 grid">
      ...
      <input
        ...
        id="__dateInput"
        type="datetime-local"
        className="font-mono uppercase bg-gray-l4 shadow-inner-white 
