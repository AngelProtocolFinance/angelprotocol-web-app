...
function DataPart({ children }: PropsWithChildren<{}>) {
  return (
    <div className="flex justify-center items-center gap-5 p-4 rounded border border-gray-l3 dark:border-blue-gray bg-orange-l6 dark:bg-blue-d6 font-bold text-sm @sm:text-base font-heading">
      {children}
    </div>
  );
}
