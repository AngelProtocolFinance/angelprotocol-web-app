  ...
  return (
    <Disclosure
      ...
      className={`border ${
        ...
        milestoneError ? "border-red" : "border-gray-l3 dark:border-bluegray"
    ...
    >
      ...
      <Disclosure.Panel
        ...
        className={({ open }) =>
          `${
            open ? "border-t border-gray-l3 dark:border-bluegray" : ""
      ...
      >
        ...
        <RichTextEditor<FV>
          ...
          classes={{
            container:
              "rich-text-toolbar border border-gray-l3 dark:border-bluegray text-sm grid grid-rows-[auto_1fr] rounded bg-gray-l6 dark:bg-blue-d5 p-3 min-h-[15rem]",
