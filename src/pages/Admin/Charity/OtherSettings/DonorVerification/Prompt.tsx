    ...
    <FormProvider {...methods}>
      ...
      >
        <div className="relative">
          <h3 className="text-xl text-center border-b bg-orange-l6 dark:bg-blue-d7 border-gray-l3 dark:border-bluegray p-5">
            Change settings
          </h3>
          <button
            onClick={closeModal}
            className="border border-gray-l3 dark:border-bluegray p-2 rounded-md absolute top-1/2 right-4 transform -translate-y-1/2 disabled:text-gray-l3 dark:disabled:text-bluegray-d1 disabled:dark:border-bluegray-d1"
          >
        ...
        <div className="flex flex-col justify-center gap-4 px-8 py-12">
          <Radio<FV, "isVerificationRequired">
            classes="px-4 py-3 border border-gray-l3 dark:border-bluegray rounded cursor-pointer"
        ...
        <div className="flex justify-center md:justify-end gap-3 p-3 sm:px-8 sm:py-4 empty:h-12 w-full text-center bg-orange-l6 dark:bg-blue-d7 border-t border-gray-l3 dark:border-bluegray">
          <button
            type="button"
