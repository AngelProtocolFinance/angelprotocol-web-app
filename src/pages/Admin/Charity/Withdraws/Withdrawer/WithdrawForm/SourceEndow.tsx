...
export default function SourceEndow({ classes = "" }) {
  ...
  return (
    ...
    >
      ...
      <Listbox.Options className="rounded-sm text-sm border border-gray-l3 dark:border-bluegray absolute top-full mt-2 z-10 bg-gray-l6 dark:bg-blue-d6 w-full max-h-[10rem] overflow-y-auto scroller">
