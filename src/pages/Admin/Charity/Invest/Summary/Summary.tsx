...
export default function Summary({
  ...
  return (
    <Modal
      as="div"
      className="grid content-start max-h-[95vh] overflow-y-auto max-w-[37.5rem] w-[95vw] sm:w-full fixed-center z-20 bg-gray-l6 dark:bg-blue-d6 border border-gray-l3 dark:border-bluegray rounded"
    >
      ...
      <div className="grid content-start m-8 px-6 py-2 border border-gray-l3 dark:border-bluegray rounded">
        <Row title="Name">
      ...
      <div className="px-8 py-4 gap-x-3 border-t border-gray-l3 dark:border-bluegray flex justify-center sm:justify-end">
        <button
...
function Row({
  ...
  return (
    <div
      className={`${classes} py-3 font-semibold text-[0.9375rem] flex items-center justify-between w-full border-b border-gray-l3 dark:border-bluegray last:border-none`}
    >
