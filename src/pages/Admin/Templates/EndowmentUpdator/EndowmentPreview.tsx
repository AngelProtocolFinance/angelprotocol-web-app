...
export default function EndowmentPreview() {
  ...
  return (
    (isRenderPreview && (
      <div className="text-sm uppercase bg-angel-blue bg-opacity-30 justify-self-start py-1 px-2 -mt-4 mb-6 ml-1 rounded-sm font-semibold font-mono text-angel-grey">
