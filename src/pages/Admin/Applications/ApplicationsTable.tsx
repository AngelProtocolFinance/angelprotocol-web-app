...
export default function ApplicationsTable(props: {
  ...
  return (
    <table className="w-full text-white/80 overflow-hidden">
      ...
      <TableSection
        type="tbody"
        rowClass="hover:bg-angel-blue hover:bg-angel-blue/10 mb-6 sm:mb-0 flex flex-row flex-wrap sm:flex-no-wrap"
      >
        {props.applications.map((ap) => (
          ...
          >
            <p className="pl-1 capitalize w-42 sm:w-32">
              {" "}
              <span className="font-bold font-thin text-xs text-white uppercase sm:hidden absolute top-0 inset-x-0 p-1 bg-gray-200/20 pl-2">
                Name
              </span>
              {ap.CharityName}
            </p>
