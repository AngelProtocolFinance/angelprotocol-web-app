          ...
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 items-center w-full font-semibold text-base">
            {p.hq_country && (
              <span className="flex items-center gap-2 uppercase">
                <Icon type="MapPin" className="h-6 w-6 text-gold" />
                {p.hq_country}
              </span>
            )}
            {p.url && (
              <span className="flex items-center gap-2">
                <Icon type="Globe" className="h-6 w-6 text-gold" />
                <ExtLink
                  href={p.url}
                  title="organization website"
                  className="cursor-pointer underline decoration-1 hover:text-gold hover:decoration-2"
                >
