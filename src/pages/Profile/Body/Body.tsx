...
export default function Body() {
  return (
    <div className="grid gap-8 justify-items-center w-full h-full pt-32 px-6 pb-8 bg-gray-l5 text-gray-d2 dark:bg-blue-d4 dark:text-white xl:grid-rows-[auto_auto_1fr] xl:grid-cols-[auto_auto] xl:items-end xl:gap-16 xl:pt-6 xl:px-20 xl:pb-20">
