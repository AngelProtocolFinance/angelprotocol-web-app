...
const SocialsIcon = (props: { href: string; iconType: IconTypes }) => (
  <a
    ...
    className="flex items-center justify-center p-2 w-10 h-10 border border-gray-d2 rounded hover:text-blue-l1 hover:border-blue-l1 active:text-blue dark:border-white"
  >
