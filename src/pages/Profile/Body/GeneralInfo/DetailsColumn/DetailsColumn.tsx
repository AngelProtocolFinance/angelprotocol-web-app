...
export default function DetailsColumn({ className = "" }) {
  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      <div
        className={`${className} flex flex-col gap-8 w-full lg:w-96 p-8 border border-gray-l3 dark:border-bluegray rounded text-gray-d2 dark:bg-blue-d6  dark:text-white`}
      >
