...
export default function Reference({ id, classes = "" }: Props) {
  ...
  return (
    <div
      className={`${classes} w-full py-4 px-6 text-sm text-left md:text-center bg-gray-l6 dark:bg-blue-d5 text-gray-d4 dark:text-white md:text-gray md:dark:text-gray md:border-t border-gray-l4 rounded-b-lg`}
    >
