...
export default function Sidebar({ classes = "" }: { classes?: string }) {
  ...
  return (
    <div
      className={`border border-gray-l2 dark:border-bluegray dark:bg-blue-d5 dark:text-white overflow-y-auto md:overflow-hidden md:rounded-md content-start md:w-80 bg-gray-l5 ${classes}`}
    >
