...
export default function Sidebar({ classes = "" }: { classes?: string }) {
  ...
  return (
    <div
      className={`border border-gray-l2 dark:border-bluegray-d1 dark:bg-blue-d4 dark:text-white overflow-hidden rounded-md content-start min-w-[18rem] bg-orange-l6 pb-3 ${classes}`}
    >
