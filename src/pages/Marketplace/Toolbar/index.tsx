...
export default function Toolbar({ classes = "" }: { classes?: string }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2 order-first col-span-2 md:order-none md:col-span-1 items-center  dark:text-gray-l2 border border-gray-l2 dark:border-bluegray rounded-md overflow-clip">
