...
export default function Sorter() {
  ...
  return (
    ...
    >
      <div className="w-full h-full flex items-center justify-between text-[0.9375rem] py-2 pl-3 dark:text-gray-l3 border border-gray-l3 dark:border-bluegray rounded-lg font-bold">
