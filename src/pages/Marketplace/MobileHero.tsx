...
export default function MobileHero({ classes = "" }: { classes?: string }) {
  return (
    <div
      className={`${classes} content-start justify-items-center padded-container text-white `}
    >
      ...
      <img src={character} alt="" className="w-full max-w-md -scale-x-100" />
    </div>
  );
}
