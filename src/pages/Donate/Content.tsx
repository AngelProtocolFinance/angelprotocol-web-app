  ...
  return (
    ...
    >
      <div className="md:padded-container grid md:grid-cols-[auto_1fr] lg:grid-cols-[auto_1fr_auto] items-start content-start gap-x-6">
        ...
        <p className="max-md:px-4 mt-4 text-sm leading-normal text-left text-navy-l1 dark:text-navy-l2 col-start-1 md:col-start-2 md:row-start-4 lg:row-start-3">
        ...
        <p className="max-md:px-4 mt-4 text-sm leading-normal text-left text-navy-l1 dark:text-navy-l2 col-start-1 md:col-start-2 md:row-start-5 lg:row-start-4">
