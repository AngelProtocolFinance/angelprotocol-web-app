...
export default function Page({ loaderData: to }: Route.ComponentProps) {
  return (
    <div className="grid justify-items-center w-full max-w-md px-6 sm:px-7 py-7 sm:py-8 bg-white border border-gray-l3 rounded-2xl">
      ...
      <h3 className="text-center text-xl sm:text-2xl font-semibold text-gray-d4 mt-6">
      ...
      <Link
        ...
        className="flex-center mt-9 w-full btn-blue h-12 sm:h-[52px] rounded-full normal-case sm:text-lg font-semibold"
      >
        Continue to Sign in
      </Link>
    </div>
