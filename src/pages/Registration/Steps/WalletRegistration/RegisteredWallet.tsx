...
export default function RegisteredWallet(props: {
  ...
  return (
    <div className="grid">
      ...
      <div className="grid mt-8 border border-gray-l3 dark:border-bluegray p-8 rounded">
        ...
        <p className="relative px-4 py-3 border border-gray-l3 dark:border-bluegray rounded flex items-center text-sm truncate">
