...
export default function Reference({ id, classes = "" }: Props) {
  ...
  return (
    <div
      className={`${classes} w-full py-4 px-6 text-sm text-left md:text-center bg-gray-l6 dark:bg-blue-d5 text-gray-d2 dark:text-white md:text-gray-d1 md:dark:text-gray md:border-t border-gray-l3 dark:border-bluegray rounded-b-lg`}
    >
...
function WithTooltip(props: {
  ...
  return cloneElement(props.children, {
    ...
    className:
      ...
      before:text-xs before:bg-gray-l6 before:dark:bg-blue-d6 before:text-gray-d1 before:dark:text-gray before:border before:border-gray-l3 dark:border-bluegray before:p-2 before:rounded`,
  });
}
