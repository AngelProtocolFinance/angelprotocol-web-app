...
export default function Steps({ classes = "" }: { classes?: string }) {
  ...
  return (
    <div
      className={`w-full md:w-[90%] max-w-[62.5rem] md:pt-8 grid md:grid-cols-[auto_1fr] md:border border-prim rounded-none md:rounded-lg bg-white dark:bg-blue-d4 ${classes}`}
    >
      <ProgressIndicator
        step={regState.step}
      ...
      <div className="grid z-10 w-full px-6 py-8 md:p-0 md:pr-8 md:shadow-none shadow-[0px_4px_6px,_0px_-4px_6px] shadow-gray-l3/80 dark:shadow-blue-d3">
        <Routes>
          <Route
            path={steps.contact}
