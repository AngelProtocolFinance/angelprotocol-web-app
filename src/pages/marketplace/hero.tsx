  ...
  return (
    ...
    >
      <div className="self-center">
        <p className="max-lg:text-center uppercase mb-2 text-blue-d1">
          Fund nonprofits that matter
        </p>
        <h1 className="mb-4 font-semibold capitalize text-center text-2xl lg:text-4xl text-balance lg:text-left">
          Giving made smarter. Impact made stronger.
        </h1>

        <p className="text-xl lg:text-2xl max-lg:text-center text-balance text-gray-d2">
