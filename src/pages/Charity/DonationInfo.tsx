...
export function DonationInfo({ openModal }: DonationInfoProps) {
  ...
  return (
    <div className="font-heading flex flex-row self-start justify-between w-full xl:p-0 xl:justify-start md:-mt-0 xl:mt-0 xl:mt-0 xl:flex-col xl:w-130 py-2">
      <div className="flex flex-col lg:w-128 2xl:min-h-1/2 bg-transparent px-0 lg:px-10">
        <span className="hidden md:block inline-block text-center text-sm py-3 px-3 max-w-250 font-semibold uppercase text-gray-200 bg-angel-blue bg-opacity-50 hover:bg-opacity-30 rounded-2xl border-t border-b border-opacity-20 2xl:-mt-4">
          SDG #{profile.un_sdg}: {sdg.title}
        </span>
        <h2 className="text-3xl lg:text-4xl font-bold text-white uppercase mt-4 tracking-wide">
      ...
      <div className="hidden md:block flex flex-col h-full 2xl:h-80 px-0 lg:px-10 mb-5">
