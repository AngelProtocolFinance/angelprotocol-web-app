...
export default function Summary(props: HoldingSummary) {
  ...
  return (
    <div className="flex flex-col bg-white bg-opacity-10 p-4 rounded-md shadow-md border border-white/10 text-white text-opacity-80">
      ...
      {props.opener !== undefined && (
        <button
          ...
          className="mt-2 mb-4 bg-blue-accent disabled:bg-grey-accent hover:bg-angel-blue bg-opacity-60 px-2 py-1 rounded-md uppercase text-xs  border-2 border-white/20 font-heading self-end"
        >
          withdraw
        </button>
      )}
