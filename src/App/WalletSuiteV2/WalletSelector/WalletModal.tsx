...
export default function WalletModal() {
  ...
  return (
    <Dialog.Panel className="absolute sm:fixed-center z-20 flex flex-col sm:items-center w-full sm:max-w-lg h-full sm:max-h-[572px] sm:border border-gray-l2 sm:rounded bg-gray-l5 text-gray-d2 dark:bg-blue-d6 dark:border-bluegray dark:text-white">
      <Dialog.Title
        as="h3"
        className="relative w-full py-6 bg-orange-l6 border-b border-gray-l2 font-heading font-black sm:font-bold sm:text-center text-xl max-sm:text-orange dark:bg-blue-d7 dark:border-bluegray"
      >
        Connect Wallet
        <button
