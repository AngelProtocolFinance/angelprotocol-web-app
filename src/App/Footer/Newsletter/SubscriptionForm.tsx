...
export default function SubscriptionForm() {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="btn btn-orange px-3 rounded-lg text-base h-10 w-full xl:w-min"
        disabled={isSubmitting}
      >
        Subscribe
      </button>
