  ...
  return (
    ...
    >
      <h3
        ...
        )} text-xl mb-5 md:mb-0 md:text-3xl text-blue-accent mt-16 text-center`}
      >
      ...
      <div className="grid justify-items-center content-start mb-5 md:mb-0">
        ...
        <p className="text-center text-xl md:text-2xl font-semibold mb-2 text-angel-grey">
          Jay Jaboneta
        </p>
        <p className="text-center text-lg md:text-xl text-angel-grey">
