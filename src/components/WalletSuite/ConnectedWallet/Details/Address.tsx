...
export default function Address({ value }: { value: string }) {
  return (
    <div className="flex items-center justify-between w-full gap-2 p-4 pl-3 bg-gray-l5 dark:bg-bluegray-d1 border border-gray-l3 dark:border-bluegray rounded">
