...
export default function ChainSelector(props: WalletState) {
  ...
  return (
    ...
    >
      <Listbox.Button
        className={`${SELECTOR_STYLE} border border-gray-l3 dark:border-bluegray rounded`}
      >
        {({ open }) => (
          <>
      ...
      <Listbox.Options className="absolute mt-1 max-h-60 w-full overflow-y-auto flex flex-col border border-gray-l3 dark:border-bluegray rounded bg-white dark:bg-blue-d6 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
