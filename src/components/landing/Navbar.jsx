...
<nav className= 'bg-white lg:h-[68px] h-[68px] relative rounded-[40px] flex justify-between items-center  lg:px-4 md:px-4 xl:px-5 px-5 md:w-full lg:w-full  font-heading m-auto overflow-hidden' id='temp'>
