    ...
    <div className="md:hidden mobile_animation  h-full w-full  relative overflow-visible">
      <div className="  w-full h-full relative mt-5 ">
        <div className="relative   top-0 h-full flex flex-col   justify-between px-[15px]">
          ...
          >
            <path
              d="M161.498 1947C238.403 1623.72 551.514 1994.07 522.051 1629.42C492.587 1264.78 69.1127 1506.29 3.19453 1152.1C-62.7237 797.919 391.712 786.51 379.727 535.49C367.742 284.47 98.0809 417.111 -2.79612 226.945C-103.673 36.7785 47.6725 28.2255 153.309 23"
              stroke="url(#paint0_linear_1054_18924)"
              strokeWidth="46"
              strokeLinecap="round"
            />
            <defs>
              <linearGradient
                id="paint0_linear_1054_18924"
                x1="42.1468"
                y1="42.008"
                x2="83.7127"
                y2="1924.94"
