...
const JoinUsBanner = () => {
  return (
    <div className="bg-[#c0d1dd] rounded-[32px] flex flex-col md:flex-row md:items-center lg:px-16 md:px-[50px] md:py-[70px] p-9 mt-[180px] bg-no-repeat bg-contain bg-center relative lg:w-[70%] w-[95%] m-auto overflow-hidden xl:max-w-[1140px] xl:m-auto  ">
      <img
        src={ban}
        alt="banner"
      ...
      <span className="z-10 font-heading mb-12">
      ...
      <button className=" font-[font-heading] z-10 px-20 py-[18px] bg-white whitespace-nowrap rounded-[40px] font-semibold md:font-bold text-2xl md:text-3xl text-[#2D8AC8] flex justify-center">
        Join Us{" "}
