...
export default function KYC(props: Props) {
  ...
  return (
    <FormProvider {...methods}>
      <Dialog.Panel
        className={`${formStyle} fixed-center z-20 rounded-md w-full max-w-xl max-h-[85vh] overflow-y-auto scroller shadow-lg border-none dark:border-2 dark:border-bluegray`}
      >
        <Form {...props} />
      </Dialog.Panel>
    </FormProvider>
