  ...
  return (
    <Modal className="fixed-center z-10 grid text-gray-d2 dark:text-white bg-white dark:bg-blue-d4 sm:w-full w-[90vw] sm:max-w-lg rounded overflow-hidden">
      <div className="relative">
        <p className="empty:h-16 text-xl font-bold text-center border-b bg-orange-l6 dark:bg-blue-d7 border-gray-l3 dark:border-bluegray p-5 font-work">
          {headline}
        </p>
        {isDismissible && (
          <button
      ...
      <div className="p-3 sm:px-8 sm:py-4 empty:h-12 w-full text-center sm:text-right bg-orange-l6 dark:bg-blue-d7 border-t border-gray-l3 dark:border-bluegray">
        {isDismissible && (
          <button
            type="button"
