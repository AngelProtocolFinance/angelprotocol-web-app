...
export default function Amount(props: VaultInfo & { balance: string }) {
  ...
  return (
    <div className="grid my-2">
      ...
      <div className="flex justify-between items-center gap-2 outline-none border rounded-lg border-angel-blue border-opacity-50 mt-3 px-2">
        <input
          {...register(props.field_id)}
          id={props.field_id}
          type="number"
          autoComplete="off"
          className="p-1 pl-0 grow w-full outline-none text-angel-grey text-xl currency-input"
        />
