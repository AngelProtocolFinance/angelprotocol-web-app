  ...
  return (
    <RG value={value} onChange={onChange} className={`grid grid-cols-[auto_auto] ${classes} justify-items-start justify-self-start gap-2`}>
      ...
      <RG.Option value={"monthly" satisfies Freq} className="group border-gray-l3 rounded pl-6 pr-7 border h-[2.625rem] flex items-center aria-checked:bg-blue-d1 aria-checked:text-white aria-checked:border-none">
        ...
        <Icon type="Check" className='hidden text-[1.3rem] ml-1 group-aria-checked:inline-block relative bottom-[1px]' />
      </RG.Option>
      <RG.Option value={"once" satisfies Freq} className="group border-gray-l3 rounded pl-6 pr-7 border h-[2.625rem] flex items-center aria-checked:bg-blue-d1 aria-checked:text-white aria-checked:border-none">
        <span>Give Once</span>
        <Icon type="Check" className='hidden text-[1.3rem] ml-1 group-aria-checked:inline-block relative bottom-[1px]' />
      </RG.Option>
    </RG>
