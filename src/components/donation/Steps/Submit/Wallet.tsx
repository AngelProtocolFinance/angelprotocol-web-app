...
export default function Wallet({ connect, logo, name }: DisconnectedWallet) {
  return (
    <button
      className="flex flex-col items-center justify-center gap-1 h-28 p-5 border border-gray-l3 rounded bg-white hover:bg-blue-l2 hover:bg-blue-l3 dark:bg-blue/50 hover:dark:bg-blue-d3 dark:border-none"
      onClick={connect}
    >
