...
function Prompt({ type, iconSize, recipient: { name } }: Props) {
  ...
  return (
    <Panel className="grid content-start fixed-center z-20 border border-prim bg-gray-l5 dark:bg-blue-d5 font-work text-gray-d2 dark:text-white w-[91%] sm:w-full max-w-[39rem] rounded overflow-hidden">
