...
export default function Popup(props: Props) {
  ...
  return (
    <Dialog.Panel className="fixed-center z-10 p-4 grid grid-rows-1a place-items-center  bg-white-grey w-full max-w-xs min-h-115  rounded-xl shadow-lg overflow-hidden">
