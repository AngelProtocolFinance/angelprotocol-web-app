...
export default function Popup(props: Props) {
  ...
  return (
    <Panel className="fixed-center z-10 p-4 grid grid-rows-[1fr_auto] place-items-center  bg-white w-full max-w-xs min-h-[15rem]  rounded-xl shadow-lg overflow-hidden">
