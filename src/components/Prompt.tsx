...
import { PropsWithChildren, cloneElement, createElement } from "react";
...
export default function Prompt({
  ...
  return createElement(inModal ? Dialog.Panel : "div", {
    className:
      "grid text-gray-d2 dark:text-white bg-white dark:bg-blue-d4 rounded overflow-hidden " +
      inModal
        ? "sm:w-full w-[90vw] fixed-center z-10 sm:max-w-lg"
        : "",
    children: (
      <>
