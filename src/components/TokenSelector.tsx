  ...
  return (
    ...
    >
      ...
      <Combobox.Options
        ...
        } border border-gray-l2 dark:border-bluegray p-1 mt-10 max-h-60 w-max overflow-y-auto rounded-md bg-orange-l6 dark:bg-blue-d7 shadow-lg focus:outline-nones`}
      >
