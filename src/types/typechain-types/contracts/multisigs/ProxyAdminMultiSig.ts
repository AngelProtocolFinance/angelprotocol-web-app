...
export interface ProxyAdminMultiSigInterface extends utils.Interface {
  functions: {
...
export interface ProxyAdminMultiSig extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxyAdminMultiSigInterface;
