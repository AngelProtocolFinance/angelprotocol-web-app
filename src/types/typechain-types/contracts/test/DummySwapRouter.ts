...
export interface DummySwapRouterInterface extends utils.Interface {
  functions: {
    ...
    "setOutputValue(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setOutputValue",
...
export interface DummySwapRouter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DummySwapRouterInterface;
  ...
  functions: {
    ...
    setOutputValue(
      _output: PromiseOrValue<BigNumberish>,
