...
export interface DummyGasServiceInterface extends utils.Interface {
  ...
  events: {
    ...
    "GasPaid(address,string,string,bytes,address,uint256,address)": EventFragment;
    ...
    "GasPaidWithToken(address,string,string,bytes,string,uint256,address,uint256,address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "GasPaid"): EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "GasPaidWithToken"): EventFragment;
...
export interface GasPaidEventObject {
  arg0: string;
  arg1: string;
  arg2: string;
  arg3: string;
...
export type GasPaidEvent = TypedEvent<
  [string, string, string, string, string, BigNumber, string],
  GasPaidEventObject
>;

export type GasPaidEventFilter = TypedEventFilter<GasPaidEvent>;
...
export interface GasPaidWithTokenEventObject {
  arg0: string;
  arg1: string;
  arg2: string;
  arg3: string;
...
export type GasPaidWithTokenEvent = TypedEvent<
  [
    string,
    string,
    string,
  ...
  GasPaidWithTokenEventObject
>;

export type GasPaidWithTokenEventFilter =
  TypedEventFilter<GasPaidWithTokenEvent>;
...
export interface DummyGasService extends BaseContract {
  ...
  filters: {
    ...
    "GasPaid(address,string,string,bytes,address,uint256,address)"(
      arg0?: null,
      arg1?: null,
      arg2?: null,
      arg3?: null,
    ...
    "GasPaidWithToken(address,string,string,bytes,string,uint256,address,uint256,address)"(
      arg0?: null,
      arg1?: null,
      arg2?: null,
      arg3?: null,
