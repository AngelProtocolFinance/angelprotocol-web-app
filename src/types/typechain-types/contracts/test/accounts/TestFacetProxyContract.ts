...
export interface TestFacetProxyContractInterface extends utils.Interface {
  functions: {
    ...
    "setTokenAllowance(uint32,address,address,uint256,uint256)": FunctionFragment;
  };
...
export interface TestFacetProxyContract extends BaseContract {
  ...
  functions: {
    ...
    setTokenAllowance(
      ...
      _spender: PromiseOrValue<string>,
      _token: PromiseOrValue<string>,
      _spenderAllowance: PromiseOrValue<BigNumberish>,
      _totalAllowance: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  };
