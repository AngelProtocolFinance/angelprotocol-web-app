...
export interface IAccountsEventsInterface extends utils.Interface {
  functions: {};
...
export interface IAccountsEvents extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAccountsEventsInterface;
