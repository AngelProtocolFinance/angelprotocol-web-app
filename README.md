...
3. `./bin/setup`
4. Create a file, `.env` on your project's root directory.
    * Please contact one of the Angel Protocol Engineering Team members for the complete list of environment variables.
